...
export default function PrivacyPolicyModal({ trigger, children }: PrivacyPolicyModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        {trigger || children || (
          <Button variant="link" className="p-0 h-auto text-blue-600 hover:text-blue-700 underline">
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            <div>
              ...
              <p className="text-gray-700 mb-3">
                ...
                которую ООО «ТеплоСервис» (далее — «Компания») может получить о пользователе во время использования им
                сайта и сервисов компании.
              </p>
            ...
            <div>
              <h3 className="font-bold text-lg mb-3">2. Персональная информация пользователей</h3>
              <p className="text-gray-700 mb-3">
                В рамках настоящей Политики под «персональной информацией пользователя» понимаются:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                <li>Персональные данные, предоставленные пользователем самостоятельно при заполнении форм на сайте</li>
                <li>Данные, которые автоматически передаются в процессе использования сайта</li>
                <li>Данные, получаемые в результате действий пользователя на сайте</li>
              </ul>
            </div>

            <div>
              <h3 className="font-bold text-lg mb-3">3. Цели обработки персональной информации</h3>
              <p className="text-gray-700 mb-3">
                Компания обрабатывает персональную информацию пользователя в следующих целях:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                <li>Предоставление услуг по установке и обслуживанию систем отопления</li>
            ...
            <div>
              <h3 className="font-bold text-lg mb-3">4. Способы и сроки обработки персональной информации</h3>
              <p className="text-gray-700 mb-3">
              ...
              <p className="text-gray-700">
                Пользователь соглашается с тем, что Компания вправе передавать персональные данные третьим лицам, в
            ...
            <div>
              <h3 className="font-bold text-lg mb-3">5. Изменение персональной информации</h3>
              <p className="text-gray-700">
                Пользователь может в любой момент изменить (обновить, дополнить) предоставленную им персональную
                информацию или её часть, а также параметры её конфиденциальности, оставив заявку на электронную почту
            ...
            <div>
              <h3 className="font-bold text-lg mb-3">6. Меры, применяемые для защиты персональной информации</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div>
              <h3 className="font-bold text-lg mb-3">7. Изменение Политики конфиденциальности</h3>
              <p className="text-gray-700">
                Компания имеет право вносить изменения в настоящую Политику конфиденциальности. При внесении изменений в
                актуальной редакции указывается дата последнего обновления. Новая редакция Политики вступает в силу с
                момента её размещения, если иное не предусмотрено новой редакцией Политики.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                Все предложения или вопросы по настоящей Политике следует направлять на электронную почту
                <a href="mailto:info@teploservice.ru" className="text-blue-600 hover:text-blue-700 mx-1">
                  info@teploservice.ru
                </a>
                .
