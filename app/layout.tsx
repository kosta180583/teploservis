...
export const metadata: Metadata = {
	...
	keywords:
		'системы отопления Белгород, установка отопления Белгород, ремонт отопления, обслуживание котлов, отопление дома, газовые котлы, электрические котлы, теплый пол, радиаторы, котельная, монтаж отопления, сервис котлов, аварийный ремонт отопления, техническое обслуживание, отопление квартиры, отопление коттеджа',
	...
	openGraph: {
		title: 'ТеплоСервис - Профессиональные системы отопления в Белгороде',
		description:
			'Установка, обслуживание и ремонт систем отопления в Белгороде. Надежные решения для вашего дома с гарантией качества.',
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: 'ТеплоСервис - Системы отопления в Белгороде',
			},
		],
		locale: 'ru_RU',
		type: 'website',
	...
	twitter: {
		...
		title: 'ТеплоСервис - Профессиональные системы отопления в Белгороде',
		description:
			'Установка, обслуживание и ремонт систем отопления в Белгороде. Надежные решения для вашего дома.',
		images: ['/og-image.jpg'],
	},
	robots: {
		index: true,
				...
				<script
					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							name: 'ТеплоСервис',
							description:
								'Профессиональная установка, обслуживание и ремонт систем отопления в Белгороде',
							url: 'https://teploservice.ru',
							telephone: '+7 (4722) 123-45-67',
