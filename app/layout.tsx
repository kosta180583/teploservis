...
export const metadata: Metadata = {
  title: "ТеплоСервис - Профессиональные системы отопления | Установка, обслуживание, ремонт",
  description:
    "Профессиональная установка, обслуживание и ремонт систем отопления в Москве. Гарантия качества, экстренный ремонт 24/7. Бесплатная консультация и выезд мастера.",
  keywords:
  ...
  twitter: {
    ...
    title: "ТеплоСервис - Профессиональные системы отопления",
    description: "Установка, обслуживание и ремонт систем отопления. Надежные решения для вашего дома.",
    images: ["/og-image.jpg"],
  },
  robots: {
    index: true,
...
export default function RootLayout({
  ...
  return (
    <html lang="ru" className={`${spaceGrotesk.variable} ${dmSans.variable} antialiased`}>
      <head>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "ТеплоСервис",
              description: "Профессиональная установка, обслуживание и ремонт систем отопления",
              url: "https://teploservice.ru",
                ...
                itemListElement: [
                  {
                    ...
                    description: "Профессиональная установка современных систем отопления",
                    price: "45000",
                    priceCurrency: "RUB",
                  ...
                  },
                  {
                    ...
                    description: "Регулярное техническое обслуживание систем отопления",
                    price: "3500",
                    priceCurrency: "RUB",
                    availability: "https://schema.org/InStock",
                    itemOffered: {
              ...
              sameAs: ["https://vk.com/teploservice", "https://t.me/teploservice", "https://wa.me/74951234567"],
            }),
          }}
        />
        <script
