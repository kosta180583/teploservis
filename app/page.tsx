...
export const metadata: Metadata = {
  title: "Установка и ремонт систем отопления в Москве | ТеплоСервис - Профессиональный монтаж котлов",
  description:
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            name: "ТеплоСервис",
            description: "Профессиональная установка и ремонт систем отопления в Москве",
            url: "https://teploservice.ru",
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    ...
                    description: "Профессиональная установка газовых и электрических котлов, радиаторов, теплых полов",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description: "Экстренный ремонт котлов, радиаторов, устранение протечек 24/7",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description: "Регулярное ТО систем отопления, чистка, настройка, профилактика",
                  },
                },
              ],
            },
