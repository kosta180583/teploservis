...
export const metadata: Metadata = {
	...
	description:
		'Профессиональная установка газовых котлов, монтаж радиаторов и теплых полов в Белгород. Экстренный ремонт 24/7, гарантия 5 лет. Бесплатная консультация ☎ +7 (495) 123-45-67',
	keywords:
	...
	openGraph: {
		...
		title: 'Установка и ремонт систем отопления в Белгороде | ТеплоСервис',
		description:
			'Профессиональная установка газовых котлов, монтаж радиаторов и теплых полов в Белгороде. Экстренный ремонт 24/7, гарантия 5 лет.',
		images: [
			{
	...
	twitter: {
		...
		title: 'Установка и ремонт систем отопления в Белгороде | ТеплоСервис',
		description:
			'Профессиональная установка газовых котлов, монтаж радиаторов и теплых полов в Белгород. Экстренный ремонт 24/7, гарантия 5 лет.',
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						name: 'ТеплоСервис',
						description:
							'Профессиональная установка и ремонт систем отопления в Белгород',
						url: 'https://teploservice.ru',
